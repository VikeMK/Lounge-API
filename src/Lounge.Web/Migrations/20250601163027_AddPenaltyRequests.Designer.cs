...
namespace Lounge.Web.Migrations
{
    ...
    [Migration("20250601163027_AddPenaltyRequests")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lounge.Web.Data.Entities.ChangeTracking.PlayerSeasonDataChange", b =>
                {
                    ...
                    b.HasIndex("PlayerId", "Game", "Season");
            ...
            modelBuilder.Entity("Lounge.Web.Data.Entities.PenaltyRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PenaltyRequests", (string)null);
                });
            ...
            modelBuilder.Entity("Lounge.Web.Data.Entities.PlayerSeasonData", b =>
                {
                    ...
                    b.HasKey("PlayerId", "Game", "Season");

                    b.HasIndex("Game", "Season", "Mmr");
            ...
            modelBuilder.Entity("Lounge.Web.Data.Entities.ChangeTracking.PlayerSeasonDataChange", b =>
                {
                    b.HasOne("Lounge.Web.Data.Entities.PlayerSeasonData", "Entity")
                        .WithMany()
                        .HasForeignKey("PlayerId", "Game", "Season")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Lounge.Web.Data.Entities.PenaltyRequest", b =>
                {
                    ...
                    b.HasOne("Lounge.Web.Data.Entities.Player", "Reporter")
                        .WithMany()
