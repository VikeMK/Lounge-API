...
namespace Lounge.Web.Data.ChangeTracking
{
    public class DbCacheData : IDbCache
    {
        ...
        public required IReadOnlyDictionary<Game, Dictionary<int, PlayerGameRegistration>> PlayerGameRegistrations { get; set; }
        public required IReadOnlyDictionary<(Game Game, int Season), Dictionary<int, PlayerSeasonData>> PlayerSeasonData { get; set; }
