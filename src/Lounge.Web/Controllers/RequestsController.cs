...
namespace Lounge.Web.Controllers
{
    ...
    public class RequestsController : ControllerBase
    {
        ...
        public RequestsController(ApplicationDbContext context, ILoungeSettingsService loungeSettingsService)
        {
        ...
        public async Task<ActionResult<PenaltyRequestViewModel>> GetPenaltyRequest(int id, Game game = Game.mk8dx)
        {
            var requestData = await _context.PenaltyRequests
                ...
                .Select(r => new { PenaltyRequest = r, PlayerName = r.Player.Name, ReporterName = r.Reporter.Name })
                .FirstOrDefaultAsync();
